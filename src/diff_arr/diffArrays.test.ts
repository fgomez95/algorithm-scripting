...
describe('diffArray', () => {
    it('should be imported correctly', () => {
		    ...
		    it('should return an array', () => {
		            expect(Array.isArray(diffArray([1, true, 'hello'], [1, false, 8]))).toEqual(true);
			        });
				    it('should return the symmetric difference of two arrays', () => {
				            const arrA: Array<any> = ['diorite', 'andesite', 'grass', 'dirt', 'pink wool', 'dead shrub']; 
						            const arrB: Array<any> = ['diorite', 'andesite', 'grass', 'dirt', 'dead shrub'];
								            expect(diffArray(arrA, arrB)).toEqual(['pink wool']);
									            ...
									            const arrC:Array<any> = [];
											            const arrD:Array<any> = ['snuffleupagus', 'cookie monster', 'elmo', false];
													            expect(diffArray(arrC, arrD)).toEqual(['snuffleupagus', 'cookie monster', 'elmo', false]);
														        });
															});
